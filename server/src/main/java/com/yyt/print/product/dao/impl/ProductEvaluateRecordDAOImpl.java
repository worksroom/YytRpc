...
public class ProductEvaluateRecordDAOImpl extends YytBaseDAO<ProductEvaluateRecord> implements
		IProductEvaluateRecordDAO {
	@Override
	...
	@Override
	public int updateProductEvaluateRecord(ProductEvaluateRecord productEvaluateRecord) {
		return super.update(productEvaluateRecord);
	}

	@Override
	public ProductEvaluateRecord getProductEvaluateRecord(int id) {
		return super.get(id);
	}

	@Override
	public int delProductEvaluateRecord(int id) {
