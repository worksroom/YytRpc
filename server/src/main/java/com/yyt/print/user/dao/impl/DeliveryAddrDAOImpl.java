...
public class DeliveryAddrDAOImpl extends YytBaseDAO<DeliveryAddr> implements IDeliveryAddrDAO {
    @Override
    public int saveDeliveryAddr(DeliveryAddr deliveryAddr){return super.insert(deliveryAddr);}
    @Override
    public int updateDeliveryAddr(DeliveryAddr deliveryAddr){return super.update(deliveryAddr);}
    @Override
    public DeliveryAddr getDeliveryAddr(int id){return super.get(id);}
    @Override
    public int delDeliveryAddr(int id){return super.delete(id);}
